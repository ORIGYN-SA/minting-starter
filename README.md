...
To verify that the sample NFT collection was deployed correctly, you can open any URL link in the ./projects/brain-matters/\_\_staged/full_def.json metadata file (after it is generated by the deploy script). All links should work in the browser, including images, videos, PDF files, dApps, etc.

Examples:

- [Local metadata file](docs/example-local-full_def.json)
- [Maininet metadata file](docs/example-mainnet-full_def.json)
